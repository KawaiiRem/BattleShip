...
{
    public partial class Volume_Controll : UserControl
    {
        public Volume_Controll()
        {
            InitializeComponent();
        ...
        bool mouse = false;
        private void Volume_Controll_MouseDown(object sender, MouseEventArgs e)
        {
            mouse = true;
            Bar_value(thumb_value(e.X));
        }

        private void Volume_Controll_MouseMove(object sender, MouseEventArgs e)
        {
            if (!mouse) return;
            Bar_value(thumb_value(e.X)); 
        }

        private void Volume_Controll_MouseUp(object sender, MouseEventArgs e)
        {
            mouse = false;
        }
